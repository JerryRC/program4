 ...
 * 
 */
@WebServiceClient(name = "TodoServiceService", targetNamespace = "http://www.todoservice.nwpu.com", wsdlLocation = "http://127.0.0.1:8001/webservice/todo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TODOSERVICESERVICE_QNAME = new QName("http://www.todoservice.nwpu.com", "TodoServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8001/webservice/todo?wsdl");
    ...
    public TodoService getTodoServicePort() {
        return super.getPort(new QName("http://www.todoservice.nwpu.com", "TodoServicePort"), TodoService.class);
    }
    ...
    public TodoService getTodoServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.todoservice.nwpu.com", "TodoServicePort"), TodoService.class, features);
    }
